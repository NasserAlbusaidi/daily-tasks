                                ...
                                <tbody>
                                    @foreach ($tasks as $key => $task)
                                        <tr data-entry-id="{{ $task->id }}">
                                            ...
                                            <td>
                                                {!! $task->status->name === 'Open' ? '<span class="badge badge-success">Open</span>' : '<span class="badge badge-danger">Closed</span>' !!}
                                            ...
                                            <td>
                                                @can('task_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.tasks.show', $task->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('task_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.tasks.edit', $task->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('task_delete')
                                                    <form action="{{ route('frontend.tasks.destroy', $task->id) }}"
                                                        method="POST"
